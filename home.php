...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/
	bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="css/home.css">
	<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/
		...
		<div class="row">
				...
				<div class="input-group searchbox">
					<div class="input-group-btn">
						<center><a href="include/find_friends.php"><button class="btn btn-default
							search-icon" name="search_user" type="submit">See Your Friends</button></a></center>
						</div>
				</div>
				<div class="left-chat">
					<ul>
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				<div class="row">
					...
					?>
					<!---getting user data on which user click on---->
					<?php
